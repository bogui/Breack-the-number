...
"""Check the Python version. Needed 3.5 or greater"""
def check_version(major, minor):
	needed_version = (major, minor)
	if needed_version > (version_info.major, version_info.minor):
		exit("\r\n[-]	Error: You mast have python 3.5 or greater!\r\n")
